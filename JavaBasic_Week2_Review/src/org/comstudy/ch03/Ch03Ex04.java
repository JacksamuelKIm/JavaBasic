...
//		startEndDanError();
	...
	private void startEndDan_timesTable3x3() {
		...
		int danNumber = endDan - startDan + 1; 
		int row1size = (danNumber>=3) ? 3:danNumber;
		int row2size = (danNumber-row1size)>=3 ? 3 : (danNumber-row1size) ; 
		int row3size = (danNumber-row1size-row2size)>=3 ? 3 : (danNumber-row1size-row2size) ;
