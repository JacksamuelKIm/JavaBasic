...
public class Ch03ArrEx01_another {
...
//		test02();
	...
	public static void main(String[] args) {
		...
		if (month == 9) {  // i=month; i %= days[month-]를 활용하면 엄청 간단한 거였네...
			next1 = month +1;
			next2 = next1 +1;
			next3 = next2 +1;
			next4 = 12 - next3 + 1;		
		...
		threeMonths = days[next1-1] + days[next2-1] + days[next3-1];		
			...
			if (100-left >= threeMonths) {// 100-left가 100일때는 안되네... 9월 22일 입력해봐. 수정함	
				month2 = (100-left==threeMonths)? next3 :next4;
				day2 =  (100-left==threeMonths)? days[next3-1]:100 - (threeMonths+left);										
			}			
